            ...
            while ( have_posts() ) : the_post();
             ?>
                <div class="event-meta-section">
                    <span class="event-start">Starts on: <br/><?php echo nexus_get_svg( array( 'icon' => 'calendar' )) . date( 'Y-m-d',strtotime(get_post_meta(get_the_ID(), 'event_start_date', true))) ?></span>
                    <span class="event-end">Ends on: <br/><?php echo nexus_get_svg( array( 'icon' => 'calendar' )) . date( 'Y-m-d',strtotime(get_post_meta(get_the_ID(), 'event_start_date', true))) ?></span>
                    <span class="event-location">Location:  <br/><?php echo nexus_get_svg( array( 'icon' => 'tag' )) . get_post_meta(get_the_ID(), 'event_location', true); ?></span>
                </div>
                <?php
